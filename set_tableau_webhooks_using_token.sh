...
function Help()
{
   ...
   echo "n     Tableau Personal Access Token name"
   echo "t     Tableau Personal Access Token token"
   echo
...
while getopts ":hdlDa:u:s:n:t:" option; do
  case $option in
    h) # display Help
      Help
      exit;;
